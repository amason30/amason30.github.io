...
tribble(
  ...
  linebreak("R -- R Markdown -- R Package Development -- Quarto --Git/Github -- Conda -- Unix/zsh -- Python -- C++ -- SQL -- Biostatistics -- Reproducible Research -- Machine learning"),
  linebreak("Soil sampling/Field research -- Amplicon Sequencing -- Data Analysis/Visualization -- Soil microbiome/necrobiome -- Metatranscriptomics -- Metabolomics"),
